...
<div style='text-align:center'>
    <h1 style='color:#FF0000;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:/Users/Rajasekar/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:/Users/Rajasekar/scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:/Users/Rajasekar/t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:/Users/Rajasekar/s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:/Users/Rajasekar/clsmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r'C:/Users/Rajasekar/cscaler.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:/Users/Rajasekar/ct.pkl", 'rb') as f:
...
st.write("App Created by Rajasekar", unsafe_allow_html=True)